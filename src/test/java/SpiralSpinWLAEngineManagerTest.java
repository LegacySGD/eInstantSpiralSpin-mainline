...
public class SpiralSpinWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SpiralSpinWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SpiralSpinIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SpiralSpinIW/InitOutcome.xml").getDocumentElement();
